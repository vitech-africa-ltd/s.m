...
const fr: Dict = {
  ...
  "Download started": "Téléchargement démarré", "Detected": "Détecté", "verified": "vérifié", "How to install": "Comment installer",
  "Download the package for your platform": "Téléchargez le paquet pour votre plateforme",
  "Run the installer and accept the license": "Lancez l'installateur et acceptez la licence",
  "Sign in with your school account": "Connectez-vous avec votre compte école",
  "Your data syncs automatically — works offline": "Vos données se synchronisent automatiquement — fonctionne hors-ligne",
  "Download history": "Historique des téléchargements", "No downloads yet this session.": "Aucun téléchargement cette session.",
  "Package still preparing — one second…": "Paquet en préparation — une seconde…",
  ...
  "Request a Demo": "Demander une démo", "Desktop app": "App desktop", "AI translation": "Traduction IA",
