...
import { useApp, mutate, audit, uid, fmtDate, type SchoolEvent } from "../lib/data";
import { Ic } from "../components/icons";
import { Modal, Field, Chip, toast } from "../components/ui";
import { PageHead } from "./Dashboard";

const KINDS = [
  { id: "exam", label: "Exams", cls: "bg-rose-500", chip: "red" as const },
  { id: "holiday", label: "Holidays", cls: "bg-emerald-500", chip: "green" as const },
  { id: "meeting", label: "Meetings", cls: "bg-cobalt-500", chip: "blue" as const },
  { id: "sports", label: "Sports", cls: "bg-gold-400", chip: "gold" as const },
  { id: "event", label: "School events", cls: "bg-amber-500", chip: "amber" as const },
  { id: "graduation", label: "Graduation", cls: "bg-ink-900 dark:bg-ink-100", chip: "navy" as const },
];
...
export default function CalendarPage() {
  ...
  const [f, setF] = useState({ title: "", date: new Date().toISOString().slice(0, 10), kind: "event", note: "" });
  ...
  const addEvent = () => {
    ...
    toast("Event added to calendar"); setForm(false); setF({ title: "", date: new Date().toISOString().slice(0, 10), kind: "event", note: "" });
  };
