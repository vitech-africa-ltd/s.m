...
import { Modal, Field, Chip, Avatar, Empty, toast, Ring, printNow } from "../components/ui";
          ...
          printNow(
            <div className="p-2 max-w-[820px] mx-auto">
              <div className="flex items-end justify-between border-b-4 border-ink-950 pb-3 mb-4">
                ...
                <div className="text-right text-[11px] text-ink-500">{db.school.academicYear} · {db.school.term}<br />{db.school.phone}</div>
              </div>
              ...
              <p className="text-[10px] text-ink-400 mt-3">Generated by VITECH School Management System · {db.school.name} · conflicts, if any, are flagged in red on screen.</p>
            </div>
          );
